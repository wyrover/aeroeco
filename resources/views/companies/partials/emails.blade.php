<div class="row col-md-10 col-md-offset-1 form-group" style="margin-top: 20px;">
...
<div class="row">
    <div class="col-md-6">
        <p>
            <select name="mail_templates" class="form-control">
                <option>Select Template to Customize</option>
                <option>New user welcome message</option>
